...
let g:WebDevIconsUnicodeDecorateFileNodesExtensionSymbols['re'] = s:getemoji('camel','') " ReasonML source code
let g:WebDevIconsUnicodeDecorateFileNodesExtensionSymbols['rei'] = '🧩' " ReasonML intermediate file
let g:WebDevIconsUnicodeDecorateFileNodesExtensionSymbols['ml'] = s:getemoji('camel','') " ReasonML source code
let g:WebDevIconsUnicodeDecorateFileNodesExtensionSymbols['mli'] = '🧩' " ReasonML intermediate file
let g:WebDevIconsUnicodeDecorateFileNodesExtensionSymbols['cmi'] = s:getemoji('battery','') " ReasonML intermediate file
...
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['.merlin'] = '🧙' " ReasonML metadata
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['.svn'] = '🐢' " SVN metadata
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['.vimspector.json'] = s:getemoji('beetle','') " vimspector config file
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['.vscode'] = '🆚' " VSCode metadata
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['.zshrc'] = s:getemoji('shell','') " zshel config file
