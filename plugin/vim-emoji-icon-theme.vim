...
let g:WebDevIconsUnicodeDecorateFileNodesExactSymbols['license'] = g:iconDocument
...
imported.set_icon { ["vite.config.cjs"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vite.config.cts"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vite.config.js"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vite.config.mjs"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vite.config.mts"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vite.config.ts"] = { icon = vim.g.iconConfig, color = "#FFA800", cterm_color = "214", name = "ViteConfig" } }
imported.set_icon { ["vitest.config.cjs"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
imported.set_icon { ["vitest.config.cts"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
imported.set_icon { ["vitest.config.js"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
imported.set_icon { ["vitest.config.mjs"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
imported.set_icon { ["vitest.config.mts"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
imported.set_icon { ["vitest.config.ts"] = { icon = vim.g.iconConfig, color = "#739B1B", cterm_color = "106", name = "VitestConfig" } }
